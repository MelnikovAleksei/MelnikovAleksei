...
* ["Mesto" (ссылка на репозиторий)](https://github.com/MelnikovAleksei/mesto) - это интерактивный сайт, на котором пользователь может добавлять и удалять фотографии, ставить им «лайк». В работе применены расширенные возможности HTML и CSS, JavaScript (Асинхронный JS, ООП в интерфейсах, работа с DOM API и Fetch API), проверка данных форм, git, Webpack. Сейчас проект переписывается на библиотеку Reactjs - [ссылка на проект Mesto (Reactjs)](https://github.com/MelnikovAleksei/mesto-react) 
